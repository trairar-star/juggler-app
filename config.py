...
BASE_FEATURES = [
    ...
    'is_prev_high_reg', 'is_high_reg_plus_diff', 'is_low_reg_plus_diff', 'is_prev_diff_over_3000', 'is_high_reg_but_over_3000_diff',
...
FEATURE_NAME_MAP = {
    ...
    'is_prev_high_reg': '前日 高設定水準REGフラグ', 'is_high_reg_plus_diff': '複合: 前日REG高&差枚プラス(本物据え狙い)', 'is_low_reg_plus_diff': '複合: 前日REG低&差枚プラス(誤爆下げ警戒)', 'is_prev_diff_over_3000': '前日 超大勝(+3000枚以上)', 'is_high_reg_but_over_3000_diff': '複合: 前日REG高&超大勝(回収警戒)',

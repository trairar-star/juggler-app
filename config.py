...
BASE_FEATURES = [
    ...
    'cons_minus_total_diff', 'prev_bonus_balance', 'prev_unlucky_gap', 'is_beginning_of_month', 'is_end_of_month', 'is_pension_day', 'past_digit_island_reg_prob', 'past_wd_island_reg_prob', 'event_x_island_avg_diff',
    'is_gw', 'is_obon', 'is_year_end_start', 
    'is_gw_before', 'is_gw_after', 'is_obon_before', 'is_obon_after', 'is_year_end_before', 'is_year_end_after', 'is_holiday',
    ...
    'is_prev_high_reg', 'is_high_reg_plus_diff', 'is_low_reg_plus_diff', 'excess_diff', 'high_reg_excess_diff', 'past_big_win_sueoki_rate',
    ...
    'is_neighbor_high_reg', 'neighbor_reg_reliability_score', 'neighbor_high_setting_count', 'is_machine_border',
    'trend_v_recovery', 'trend_cont_lose', 'trend_cont_win', 'trend_down_rebound',
    'history_count', 'machine_code', 'shop_code', 'reg_ratio', 'is_corner', 'is_corner_2', 'is_main_corner', 'is_zorome',
...
FEATURE_NAME_MAP = {
    ...
    'reg_ratio': '前日 REG比率', 'is_corner': '角台フラグ', 'is_corner_2': 'カド2フラグ', 'is_main_corner': 'メイン角フラグ', 'is_zorome': 'ゾロ目台フラグ', 'is_main_island': '目立つ島フラグ', 'is_wall_island': '壁側島フラグ',
    'is_neighbor_high_reg': '隣台(並び) REG高設定水準', 'neighbor_reg_reliability_score': '隣台(並び) REG確率×稼働量', 'neighbor_high_setting_count': '隣台(並び) 高設定示唆台数', 'is_machine_border': '機種またぎフラグ',
    ...
    'is_gw': '大型連休: GW', 'is_obon': '大型連休: お盆', 'is_year_end_start': '大型連休: 年末年始',
    'is_gw_before': '大型連休前: GW', 'is_gw_after': '大型連休後: GW',
    'is_obon_before': '大型連休前: お盆', 'is_obon_after': '大型連休後: お盆',
    'is_year_end_before': '大型連休前: 年末年始', 'is_year_end_after': '大型連休後: 年末年始', 'is_holiday': '国民の祝日・振休',
    ...
    'is_prev_high_reg': '前日 高設定水準REGフラグ', 'is_high_reg_plus_diff': '複合: 前日REG高&差枚プラス(本物据え狙い)', 'is_low_reg_plus_diff': '複合: 前日REG低&差枚プラス(誤爆下げ警戒)', 'excess_diff': '前日 超過差枚(+1000枚以上)', 'high_reg_excess_diff': '複合: 前日REG高&超過差枚(出すぎ警戒)', 'past_big_win_sueoki_rate': '店舗 過去の大勝台据え置き率',

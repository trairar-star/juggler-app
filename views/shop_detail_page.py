    ...
    if df_importance is not None and not df_importance.empty:
        ...
        if not imp_shop.empty:
            feature_name_map = {
                ...
                'target_date_end_digit': '日付末尾', 'weekday_avg_diff': '店舗 曜日平均',
                'mean_7days_diff': '台 直近7日平均', 'median_7days_diff': '台 7日中央値', 'win_rate_7days': '台 7日間高設定率', 'plus_rate_7days': '台 7日間勝率',
                '連続マイナス日数': '連続凹み日数', '連続プラス日数': '連続勝ち日数', '連続低稼働日数': '連続放置日数', 'machine_code': '機種', 'shop_code': '店舗',
                ...
                'event_avg_diff': 'イベント 平均差枚', 'event_code': 'イベント 種類', 'event_rank_score': 'イベント ランク', 'prev_差枚': '前々日 差枚数',
                ...
                'cons_minus_total_diff': '連続凹み 吸込み量', 'machine_no_30days_avg_diff': '場所 30日平均',
                ...
                'is_low_play_high_reg': '低稼働&高設定挙動', 'is_hot_wd_and_heavy_lose': '還元曜&週間大凹み',

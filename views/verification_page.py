                        ...
                        for shop_idx, shop_name in enumerate(all_shops):
                            ...
                            def objective_all(trial):
                                params = {
                                    ...
                                    'min_child_samples': trial.suggest_int('min_child_samples', 40, 150, step=10),
                                ...
                                try:
                                    ...
                                    # 全体の順位付けの妥当性(AUC)を最優先し、細かなノイズに騙されないようにする
                                    score = (auc * 500) + (win_rate * 100) + (high_rate * 100) + (avg_diff / 10)
                                    return score
                                except Exception:
                                    return -1.0
        ...
        if auto_tune_btn:
            with st.spinner("AIが過去データを分割し、数多くの組み合わせから最適な設定を探索中... (約10〜20秒かかります)"):
                ...
                if len(shop_df) < 150:
                    ...
                    param_candidates = [
                        {'n_estimators': 200, 'learning_rate': 0.02, 'num_leaves': 15, 'max_depth': 3, 'min_child_samples': 60, 'reg_alpha': 1.0, 'reg_lambda': 1.0},
                        {'n_estimators': 300, 'learning_rate': 0.01, 'num_leaves': 7,  'max_depth': 3, 'min_child_samples': 80, 'reg_alpha': 2.0, 'reg_lambda': 2.0},
                        {'n_estimators': 150, 'learning_rate': 0.05, 'num_leaves': 15, 'max_depth': 4, 'min_child_samples': 50, 'reg_alpha': 0.5, 'reg_lambda': 0.5},
                        {'n_estimators': 400, 'learning_rate': 0.01, 'num_leaves': 7,  'max_depth': 3, 'min_child_samples': 100, 'reg_alpha': 3.0, 'reg_lambda': 3.0},
                        {'n_estimators': 250, 'learning_rate': 0.03, 'num_leaves': 31, 'max_depth': 4, 'min_child_samples': 40, 'reg_alpha': 0.1, 'reg_lambda': 0.1},
                        {'n_estimators': 100, 'learning_rate': 0.05, 'num_leaves': 7,  'max_depth': 2, 'min_child_samples': 70, 'reg_alpha': 1.0, 'reg_lambda': 1.0},
                        {'n_estimators': 500, 'learning_rate': 0.01, 'num_leaves': 15, 'max_depth': 4, 'min_child_samples': 60, 'reg_alpha': 0.5, 'reg_lambda': 2.0},
                        {'n_estimators': 300, 'learning_rate': 0.02, 'num_leaves': 31, 'max_depth': 5, 'min_child_samples': 50, 'reg_alpha': 2.0, 'reg_lambda': 0.5},
                    ]
